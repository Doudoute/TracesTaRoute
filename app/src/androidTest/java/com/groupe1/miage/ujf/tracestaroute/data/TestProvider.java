...
public class TestProvider extends AndroidTestCase {
    ...
    /*
        ...
        Students: Uncomment this test to make sure you've correctly registered the TrackProvider.
     */
...
//            assertEquals("Error: TrackProvider registered with authority: " + providerInfo.authority +
...
//            assertTrue("Error: TrackProvider not registered at " + mContext.getPackageName(),
//                    false);
//        }
//    }
    ...
    public void testGetType() {
        ...
        type = mContext.getContentResolver().getType(
                TrackEntry.buildTrackLocation(testLocation));
        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
        assertEquals("Error: the TrackEntry CONTENT_URI with location should return TrackEntry.CONTENT_TYPE",
                TrackEntry.CONTENT_TYPE, type);

        String testDate = "1419120000L"; // December 21st, 2014
        // content://com.example.android.sunshine.app/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                TrackEntry.buildTrackLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/com.example.android.sunshine.app/weather/1419120000
        assertEquals("Error: the TrackEntry CONTENT_URI with location and date should return TrackEntry.CONTENT_ITEM_TYPE",
    ...
    public void testBasicTrackQuery() {
        ...
        long weatherRowId = db.insert(TrackEntry.TABLE_NAME, null, trackValues);
        assertTrue("Unable to Insert TrackEntry into the Database", weatherRowId != -1);
        ...
        TestUtilities.validateCursor("testBasicTrackQuery", weatherCursor, trackValues);
    }
...
//    }
    ...
    static ContentValues[] createBulkInsertTrackValues(long locationRowId) {
        ...
        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, currentTestDate+= "a" ) {
            ContentValues trackValues = new ContentValues();
			trackValues.put(TrackContract.TrackEntry.COLUMN_TRACK_ID, "id de test");
